...
This creates a new project named `okta-app` and will install all required dependencies. The simplest way to add authentication into an Angular app is using the library [Okta Auth JS](okta_auth_sdk).
