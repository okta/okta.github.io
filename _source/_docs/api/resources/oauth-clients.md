...
| logo_uri                    | Not currently implemented in Okta. URL string that references a logo for the client approval dialogs (not sign-in dialogs) | String                                                                                       | TRUE     | FALSE  | FALSE     |
