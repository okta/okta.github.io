...
| auto_key_rotation          | Optional: requested key rotation mode for an OIDC client       | Boolean                                                                     | TRUE     | FALSE  | FALSE      |
...
| auto_key_rotation          | Optional: requested key rotation mode for an OIDC client                         | Boolean  | TRUE     |
|----------------------------+----------------------------------------------------------------------------------+----------+----------|
...
* If `auto_key_rotation` is not specified, the client will automatically opt in for Okta's [key rotation](/docs/api/resources/oidc.html#validating-id-tokens). This property may be updated via the the API and via the Okta admin UI.
