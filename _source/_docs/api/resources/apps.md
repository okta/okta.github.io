...
| issuerMode {% api_lifecycle ea %}  | Indicates whether the `issuer` value is the original Okta org domain URL, or a custom domain URL. | `CUSTOM_URL` or `ORG_URL` | TRUE | FALSE | TRUE | `CUSTOM_URL` |
