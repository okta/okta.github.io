...
If you have many groups to specify, you can [create a groups whitelist](/docs/how-to/creating-token-with-groups-claim.html) and reuse the list in different claims.
