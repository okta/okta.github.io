...
excludeAttributes | The user profile attributes whose attribute values must be excluded from the password: currently only supports `firstName` and `lastName` | Array | No | Empty Array
