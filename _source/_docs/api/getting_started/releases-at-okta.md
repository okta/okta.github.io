...
Changes, regardless of lifecycle stage, are always reported in the [Okta Identity Cloud Release Notes](/docs/platform-release-notes/platform-release-notes.html).
...
As with all changes that affect our customers, changes outside the regular Beta-EA-GA lifecycle are reported in the [Okta Identity Cloud Release Notes](/docs/platform-release-notes/platform-release-notes.html).
