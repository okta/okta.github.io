...
> If you would prefer to download a complete sample application, please visit [Angular Sample Applications for Okta][] and follow the instructions in that readme.
