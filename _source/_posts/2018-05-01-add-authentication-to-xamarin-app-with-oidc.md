...
Once you're in your account, create a new native app in the Applications tab.

{% img blog/xamarin-oidc/okta-dashboard.png alt:"Okta Dashboard" width:"800" %}{: .center-image }

From there you need to collect these values which you'll need when implementing authentication in your mobile app:
