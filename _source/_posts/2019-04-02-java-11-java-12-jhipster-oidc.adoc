---
layout: blog_post
title: "Updated OpenID Connect Support in JHipster 6"
title: "Use Java 11 (or Java 12) with JHipster 6"
...
JHipster is one of the my favorite open source projects on the planet. It's a development platform to generate, develop, and deploy Spring Boot + Angular applications. In addition, it supports React, Vue, and creating microservice architectures with Netflix OSS, the Elastic Stack, and Docker.
...
JHipster 6 hasn't been released yet, but the project is _very_ close to releasing the first v6 beta. Before you worry about installing JHipster, install Java 11. I recommend using https://sdkman.io/[SDKMAN!] for this task. If you don't have it installed, it's just a command away:
...
At the time of this writing, JHipster 6 has not been released. When it is, I'll update this post to show you how to install it. In the meantime, you can clone the project from GitHub:
...
Next, cd into the project's directory in a terminal and run `npm link`.
...
This will create a multitude of files and install dependencies using `npm install`. Your terminal should look similar to the following.

image::{% asset_path 'blog/java-11-jhipster-6/import-jdl.png' %}[alt=Results of import-jdl,width=800,align=center]
...
== Run Your JHipster App and Login with Keycloak
...
image::{% asset_path 'blog/java-11-jhipster-6/welcome-java-hipster.png' %}[alt="Welcome, Java Hipster",width=800,align=center]
...
NOTE: If you're confused by how OAuth 2.0 and OIDC work together, please see my link:/blog/2017/06/21/what-the-heck-is-oauth[What the Heck is OAuth?] post. In short, OIDC is a thin layer on top of OAuth 2.0 that adds identity.
...
image::{% asset_path 'blog/java-11-jhipster-6/app-settings.png' %}[alt=OIDC App Settings,width=700,align=center]
...
image::{% asset_path 'blog/java-11-jhipster-6/add-claim.png' %}[alt=Add Claim,width=600,align=center]
...
image::{% asset_path 'blog/java-11-jhipster-6/authenticated-by-okta.png' %}[alt=Authenticated by Okta,width=800,align=center]

Isn't it cool how easy Spring Boot and Spring Security make it to switch OIDC providers?!
