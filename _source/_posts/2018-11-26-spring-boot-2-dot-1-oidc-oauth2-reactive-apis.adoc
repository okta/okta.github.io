...
* Dec 19, 2018: Updated to use Okta Spring Boot Starter 1.0.0. You can see the changes to this post in https://github.com/okta/okta.github.io/pull/2580[okta.github.io#2580].