...
This tutorial showed you how to build a secure Spring Boot API (powered by JPA, PostgreSQL, and Elasticsearch) with just a few commands. Then you learned how to use Docker to run external services, your app, and verify you had high-quality code with Sonar. And that was just the beginning!
