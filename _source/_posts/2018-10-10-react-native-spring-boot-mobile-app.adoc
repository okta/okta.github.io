...
[source,bash]
----
npm i -g ignite-cli@2.1.6 ignite-jhipster@2.0.0
----
...
When prompted for the path to your JHipster project, enter `jhipster-api`. Answer the other questions about statistics and end-to-end tests however you like.
...
Ignite JHipster also adds your app's URL scheme, `healthpoints://*`, to `src/main/docker/realm-config/jhipster-realm.json`.

== Modify React Native App for OAuth 2.0 / OIDC Login

Ignite JHipster automatically configures your React Native app so OIDC login works. You can see the https://github.com/ruddell/ignite-jhipster/blob/master/docs/oauth2-oidc.md[details in its documentation].
