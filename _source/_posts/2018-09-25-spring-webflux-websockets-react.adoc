...
<video src="{% asset_path 'blog/spring-full-stack-reactive/eventsource.mp4' %}" width="360" class="center-image" autoplay controls></video>
...
You can find the source code used in this post [on GitHub](https://github.com/oktadeveloper/okta-spring-webflux-react-example/tree/react-app). You can clone it and checkout the `react-app` branch:
