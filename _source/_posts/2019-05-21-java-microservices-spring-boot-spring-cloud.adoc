...
INFO: JHipster also https://www.jhipster.tech/consul/[supports Hashicorp Consul].
...
We're big fans of Spring Boot, Spring Cloud, and JHipster on this blog. Here's a few other posts you might find interesting:
