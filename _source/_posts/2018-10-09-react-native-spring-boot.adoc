...
image::{% asset_path 'blog/react-native-app-auth/avd-pixel-2.png' %}[alt=AVD Pixel 2,width=800,role=center-image]
...
image::{% asset_path 'blog/react-native-app-auth/ignite-entities.png' %}[alt=Ignite JHipster Entities Screen,width=550,role=center-image]

Click on **Points** and you should be able to add points.

image::{% asset_path 'blog/react-native-app-auth/create-points.png' %}[alt=Create Points Screen,width=550,role=center-image]
...
image::{% asset_path 'blog/react-native-app-auth/create-points-defaults.png' %}[alt=Create Points with defaults,width=550,role=center-image]
...
image::{% asset_path 'blog/react-native-app-auth/react-checkboxes.png' %}[alt=checkboxes in React app,width=800,role=center-image]
...
image::{% asset_path 'blog/react-native-app-auth/okta-signup.png' %}[alt=Okta Developer Signup,width=800,role=center-image]
...
image::{% asset_path 'blog/react-native-app-auth/react-native-okta-login.png' %}[alt=Okta Login in React Native,width=550,role=center-image]

== Debugging React Native Apps

If you have issues, or just want to see what API calls

Reactotron and debug tips

*

* Update API setting and Deploy to iPhone
