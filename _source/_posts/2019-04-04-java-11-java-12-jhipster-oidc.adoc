...
If you're interested in how I upgraded JHipster's tests to Spring Security 5.1, see /blog/2019/04/15/testing-spring-security-oauth-with-junit[]Upgrading Spring Security OAuth and JUnit Tests through the 👀 of a Java Hipster].
