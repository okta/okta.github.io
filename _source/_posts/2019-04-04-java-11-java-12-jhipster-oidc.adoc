...
* May 10, 2019: Updated to use JHipster 6.0 GA release and embed screencast. Changes to this post can be viewed in https://github.com/okta/okta.github.io/pull/2456[okta.github.io#2456].
